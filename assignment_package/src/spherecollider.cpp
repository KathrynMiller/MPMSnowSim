...
SphereCollider::SphereCollider(const glm::vec3 &center, const float &radius, GLWidget277* context, glm::vec3 t, glm::vec3 r, glm::vec3 s):
    center(center), radius(radius), Collider(context, t, r, s)
{}
