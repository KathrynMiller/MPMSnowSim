...
public:
    ...
    int attrIDs; // A handle for the "in" ivec2 representing Joint IDS in the vertex shader
    int attrInf; // handle for the in vec2 representing joint weight

    int unifModel; // A handle for the "uniform" mat4 representing model matrix in the vertex shader
    int unifModelInvTr; // A handle for the "uniform" mat4 representing inverse transpose of the model matrix in the vertex shader
    int unifViewProj; // A handle for the "uniform" mat4 representing combined projection and view matrices in the vertex shader
    int unifColor; // A handle for the "uniform" vec4 representing color of geometry in the vertex shader
    int unifBindMatrices; //handle for the "uniform" array of bind matrices
    int unifOverallTrans; //handle for the "uniform" array of overall transformation matrices
